...
urlpatterns = patterns('',
    ...
    url(r'^materials/(?P<mid>[0-9a-z]+)/(?P<version>\d+)/$', content_views.MaterialDetail.as_view(), name='material-detail'), #url(r'^materials/(?P<pk>[0-9]+)/$', content_views.MaterialDetail.as_view(), name='material-detail'),
