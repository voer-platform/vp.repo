...
urlpatterns = patterns('',
    ...
    url(r'^materials/(?P<mid>[0-9a-z]+)/$', content_views.MaterialList.as_view(), name='material-version-list'),
    url(r'^materials/(?P<mid>[0-9a-z]+)/(?P<version>(\d+)|(latest))/$', content_views.MaterialDetail.as_view(), name='material-detail'), #url(r'^materials/(?P<pk>[0-9]+)/$', content_views.MaterialDetail.as_view(), name='material-detail'),
