...
urlpatterns += patterns('',
    ...
    url(r'^materials/(?P<mid>[0-9a-z]+)(/(?P<version>\d+))?/pdf/?$',
        storage_views.getMaterialExport, name='material-pdf'),
    url(r'^materials/(?P<mid>[0-9a-z]+)(/(?P<version>\d+))?/epub/?$',
        storage_views.getMaterialExport, name='material-epub'),
    url(r'^materials/(?P<mid>[0-9a-z]+)(/(?P<version>\d+))?/zip/?$',
        storage_views.getMaterialZip, name='material-zip'),
