...
urlpatterns = patterns('',
    ...
    url(r'^mfiles/(?P<mfid>[0-9a-z]+)/$', content_views.MaterialFileList.as_view(), name='material-file-list'), 
    #url(r'^mfiles/(?P<mfid>\d*)$', content_views.MaterialFileDetail.as_view(), name='material-file-detail'), 
